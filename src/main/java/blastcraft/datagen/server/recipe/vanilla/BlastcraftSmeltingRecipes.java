...
public class BlastcraftSmeltingRecipes extends AbstractRecipeGenerator {
	...
	CustomCookingRecipe
		.smeltingRecipe(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.smooth), 0.1F, 200)
		//
	...
	CustomCookingRecipe
		.blastingRecipe(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.smooth), 0.1F, 100)
		//
		.input(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.base))
		//
	...
	CustomCookingRecipe
		.smeltingRecipe(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.smooth),
			0.1F, 200)
		//
	...
	CustomCookingRecipe
		.blastingRecipe(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.smooth),
			0.1F, 100)
		//
		.input(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.base))
		//
	...
	CustomCookingRecipe
		.smeltingRecipe(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.smooth), 0.1F,
			200)
		//
	...
	CustomCookingRecipe
		.blastingRecipe(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.smooth), 0.1F,
			100)
		//
		.input(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.base))
		//
	...
	CustomCookingRecipe
		.smeltingRecipe(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.smooth), 0.1F, 200)
		//
	...
	CustomCookingRecipe
		.blastingRecipe(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.smooth), 0.1F, 100)
		//
		.input(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.base))
		//
