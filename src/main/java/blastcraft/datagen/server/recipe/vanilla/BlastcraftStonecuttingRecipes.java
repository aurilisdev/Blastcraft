...
public class BlastcraftStonecuttingRecipes extends AbstractRecipeGenerator {
	...
	public void addRecipes(Consumer<FinishedRecipe> consumer) {
		...
		CustomSingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.of(BlastcraftTags.Items.SOLID_CONCRETES), BlastcraftItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.regular), 1).complete(Blastcraft.ID, "stonecutting_concrete_regular", consumer);
		CustomSingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.of(BlastcraftTags.Items.SOLID_CONCRETES), BlastcraftItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.regular_stairs), 1).complete(Blastcraft.ID, "stonecutting_concrete_regular_stairs", consumer);
		CustomSingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.of(BlastcraftTags.Items.SOLID_CONCRETES), BlastcraftItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.regular_wall), 1).complete(Blastcraft.ID, "stonecutting_concrete_regular_wall", consumer);
		CustomSingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.of(BlastcraftTags.Items.SOLID_CONCRETES), BlastcraftItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.regular_slab), 2).complete(Blastcraft.ID, "stonecutting_concrete_regular_slab", consumer);

		// BRICKS

		CustomSingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.of(BlastcraftTags.Items.SOLID_CONCRETES), BlastcraftItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.bricks), 1).complete(Blastcraft.ID, "stonecutting_concrete_bricks", consumer);
		CustomSingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.of(BlastcraftTags.Items.SOLID_CONCRETES), BlastcraftItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.bricks_stairs), 1).complete(Blastcraft.ID, "stonecutting_concrete_bricks_stairs", consumer);
		CustomSingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.of(BlastcraftTags.Items.SOLID_CONCRETES), BlastcraftItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.bricks_wall), 1).complete(Blastcraft.ID, "stonecutting_concrete_bricks_wall", consumer);
		CustomSingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.of(BlastcraftTags.Items.SOLID_CONCRETES), BlastcraftItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.bricks_slab), 2).complete(Blastcraft.ID, "stonecutting_concrete_bricks_slab", consumer);

		// TILE

		CustomSingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.of(BlastcraftTags.Items.SOLID_CONCRETES), BlastcraftItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.tile), 1).complete(Blastcraft.ID, "stonecutting_concrete_tile", consumer);
		CustomSingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.of(BlastcraftTags.Items.SOLID_CONCRETES), BlastcraftItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.tile_stairs), 1).complete(Blastcraft.ID, "stonecutting_concrete_tile_stairs", consumer);
		CustomSingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.of(BlastcraftTags.Items.SOLID_CONCRETES), BlastcraftItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.tile_wall), 1).complete(Blastcraft.ID, "stonecutting_concrete_tile_wall", consumer);
		CustomSingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.of(BlastcraftTags.Items.SOLID_CONCRETES), BlastcraftItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.tile_slab), 2).complete(Blastcraft.ID, "stonecutting_concrete_tile_slab", consumer);
