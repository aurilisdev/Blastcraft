...
public class BlastcraftCraftingTableRecipes extends AbstractRecipeGenerator {
	...
	/*
	 * ShapedCraftingRecipeBuilder.start(BlastcraftItems.ITEM_SPEEDUPGRADE_ADVANCED.
	 ...
	 * 
	 * ShapedCraftingRecipeBuilder.start(BlastcraftItems.ITEM_SPEEDUPGRADE_BASIC.get
	 * (), 1) // .addPattern("PGP") // .addPattern("WWW") // .addPattern("CGC") //
	 * .addKey('P', Tags.Items.INGOTS_IRON) // .addKey('G',
	 ...
	 * 
	 * ShapedCraftingRecipeBuilder.start(BlastcraftItems.ITEM_UPGRADEITEMINPUT.get()
	 ...
	 * 
	 * ShapedCraftingRecipeBuilder.start(BlastcraftItems.ITEM_UPGRADEITEMOUTPUT.get(
	 * ), 1) // .addPattern("C") // .addPattern("P") // .addPattern("A") //
	 * .addKey('A', Tags.Items.INGOTS_GOLD) // .addKey('C',
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_WALLINGGLASS.getValue(SubtypeWallingGlass.blastproofwalling), 1)
		//
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_WALLINGGLASS.getValue(SubtypeWallingGlass.rawblastproofwalling), 1)
		//
		.addIngredient(Tags.Items.GLASS_BLOCKS)
		//
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_WALLINGGLASS.getValue(SubtypeWallingGlass.carbonplatedwalling), 1)
		//
		.addIngredient(Tags.Items.GLASS_BLOCKS)
		//
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_WALLINGGLASS.getValue(SubtypeWallingGlass.hardenedbricks), 1)
		//
		.addIngredient(Tags.Items.GLASS_BLOCKS)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.base_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.base), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.base_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.base_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.base))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.big_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.big), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.big_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.big_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.big))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.smooth_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.smooth), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.smooth_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.smooth_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.smooth))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.polished), 4)
		//
		.addPattern("BB")
		//
		.addPattern("BB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.polished_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.polished), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.polished_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.polished_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_HARDENEDBRICKS.getValue(SubtypeHardenedBricks.polished))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.base), 3)
		//
		.addPattern("OHO")
		//
		.addPattern("OHO")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.base_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.base), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.base_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.base_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.base))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.big), 4)
		//
		.addPattern("BB")
		//
		.addPattern("BB")
		//
		.addKey('B',
			new ItemStack(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.base)))
		//
		.complete(Blastcraft.ID, "big_rawblastproofwalling", output);

	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.big_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.big), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.big_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.big_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.big))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.smooth_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.smooth), 1)
		//
		.addIngredient(
			BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.smooth_stairs))
		//
		.complete(Blastcraft.ID, "smooth_rawblastproofwall_stairsreset", output);

	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.smooth_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.smooth_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.smooth))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.polished), 4)
		//
		.addPattern("BB")
		//
		.addPattern("BB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.polished_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.polished), 1)
		//
		.addIngredient(
			BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.polished_stairs))
		//
		.complete(Blastcraft.ID, "polished_rawblastproofwall_stairsreset", output);

	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.polished_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapelessCraftingRecipeBuilder
		...
		//
		.addIngredient(
			BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.polished_wall))
		//
		.complete(Blastcraft.ID, "polished_rawblastproofwall_wallreset", output);

	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.polished_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.polished))
	...
	ShapelessCraftingRecipeBuilder
		...
		//
		.addIngredient(
			BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.polished_slab))
		//
		.addIngredient(
			BlastcraftItems.ITEMS_RAW_BLASTPROOFWALL.getValue(SubtypeRawBlastproofWall.polished_slab))
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.base_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.base), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.base_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.base_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.base))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.big_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.big), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.big_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.big_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.big))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.smooth_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.smooth), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.smooth_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.smooth_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.smooth))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.polished), 4)
		//
		.addPattern("BB")
		//
		.addPattern("BB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.polished_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.polished), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.polished_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.polished_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_BLASTPROOFWALL.getValue(SubtypeBlastproofWall.polished))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.base), 3)
		//
		.addPattern("CWC")
		//
		.addPattern("CWC")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.base_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.base), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.base_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.base_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.base))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.big), 4)
		//
		.addPattern("BB")
		//
		.addPattern("BB")
		//
		.addKey('B',
			new ItemStack(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.base)))
		//
		.complete(Blastcraft.ID, "big_carbonplatedwalling", output);

	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.big_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.big), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.big_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.big_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.big))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.smooth_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.smooth), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.smooth_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.smooth_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.smooth))
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.polished), 4)
		//
		.addPattern("BB")
		//
		.addPattern("BB")
		//
		.addKey('B',
			new ItemStack(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.smooth)))
		//
		.complete(Blastcraft.ID, "polished_carbonplatedwalling", output);

	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.polished_stairs), 6)
		//
		.addPattern("B  ")
		//
		.addPattern("BB ")
	...
	ShapelessCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.polished), 1)
		//
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.polished_wall), 6)
		//
		.addPattern("BBB")
		//
		.addPattern("BBB")
	...
	ShapedCraftingRecipeBuilder
		.start(BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.polished_slab), 6)
		//
		.addPattern("BBB")
		//
		.addKey('B', BlastcraftItems.ITEMS_CARBONPLATEDWALL.getValue(SubtypeCarbonPlatedWall.polished))
