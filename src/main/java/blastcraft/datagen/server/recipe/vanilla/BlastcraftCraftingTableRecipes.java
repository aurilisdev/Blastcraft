...
public class BlastcraftCraftingTableRecipes extends AbstractRecipeGenerator {
	...
	private static void addMachines(Consumer<IFinishedRecipe> output) {
	...
	private static void addHardenedBricks(Consumer<IFinishedRecipe> output) {
	...
	private static void addRawBlastproofWalls(Consumer<IFinishedRecipe> output) {
	...
	private static void addBlastproofWalls(Consumer<IFinishedRecipe> output) {
	...
	private static void addCarbonPlatedWalls(Consumer<IFinishedRecipe> output) {
