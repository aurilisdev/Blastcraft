...
public class BlastcraftItemModelsProvider extends BaseItemModelsProvider {
	...
	layeredItem(BlastcraftItems.ITEM_CONCRETEMIX, Parent.GENERATED,
		itemLoc(name(BlastcraftItems.ITEM_CONCRETEMIX)));

	// layeredBuilder(name(BlastcraftItems.ITEM_SPEEDUPGRADE_BASIC),
