...
public class BlastcraftItems {
	...
	public static final RegistryObject<Item> ITEM_CONCRETEMIX = ITEMS.register("concretemix", () -> new ItemDescriptable(new Item.Properties().tab(References.CORETAB), BallistixTextUtils.tooltip("concretemix").withStyle(ChatFormatting.GRAY)));
