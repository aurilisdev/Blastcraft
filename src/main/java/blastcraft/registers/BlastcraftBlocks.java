...
public class BlastcraftBlocks {
    ...
    public static final DeferredHolder<Block, GenericMachineBlock> BLOCK_BLASTCOMPRESSOR = BLOCKS.register(
	    "blastcompressor", () -> new GenericMachineBlock(TileBlastCompressor::new, VoxelShapeProvider.DEFAULT));
    public static final DeferredHolder<Block, BlockCamoflage> BLOCK_CAMOFLAGE = BLOCKS.register("camoflage",
	    BlockCamoflage::new);
    public static final BulkDeferredHolder<Block, Block, SubtypeBlastproofWall> BLOCKS_BLASTPROOFWALL = new BulkDeferredHolder<>(
    ...
    public static final BulkDeferredHolder<Block, Block, SubtypeRawBlastproofWall> BLOCKS_RAW_BLASTPROOFWALL = new BulkDeferredHolder<>(
    ...
    public static final BulkDeferredHolder<Block, Block, SubtypeCarbonPlatedWall> BLOCKS_CARBONPLATEDWALL = new BulkDeferredHolder<>(
    ...
    public static final BulkDeferredHolder<Block, Block, SubtypeHardenedBricks> BLOCKS_HARDENEDBRICKS = new BulkDeferredHolder<>(
    ...
    public static final BulkDeferredHolder<Block, Block, SubtypeConcrete> BLOCKS_CONCRETE = new BulkDeferredHolder<>(
		...
		new BlockCustomSlab(subtype.hardness / 2.0F, subtype.resistance / 2.0F);
	    case bricks_stairs, regular_stairs,
		    tile_stairs ->
		new BlockCustomStairs(BlastcraftBlocks.BLOCKS_CONCRETE
			.getValue(SubtypeConcrete.valueOf(subtype.name().split("_")[0])).defaultBlockState(),
			subtype.hardness, subtype.resistance);
	    default -> new BlockCustomBricks(subtype.hardness, subtype.resistance);
	    }));
    public static final BulkDeferredHolder<Block, BlockCustomGlass, SubtypeWallingGlass> BLOCKS_WALLINGGLASS = new BulkDeferredHolder<>(
	    SubtypeWallingGlass.values(), subtype -> BLOCKS.register(subtype.tag(),
		    () -> new BlockCustomGlass(subtype.hardness, subtype.resistance)));
    public static final DeferredHolder<Block, PressurePlateBlock> BLOCK_GLASSPRESSUREPLATE = BLOCKS
	    .register("glasspressureplate", () -> new PressurePlateBlock(BlockSetType.STONE,
		    Properties.ofFullCopy(Blocks.GLASS).noCollission().strength(0.5F).sound(SoundType.GLASS)));
    public static final DeferredHolder<Block, BlockSpike> BLOCK_SPIKE = BLOCKS.register("spike", BlockSpike::new);
    public static final DeferredHolder<Block, BlockSpikeFire> BLOCK_FIRESPIKE = BLOCKS.register("spikefire",
	    BlockSpikeFire::new);
    public static final DeferredHolder<Block, BlockSpikePoison> BLOCK_POISONSPIKE = BLOCKS.register("spikepoison",
