...
public class BlastcraftBlockTypes {
	...
	public static final RegistryObject<BlockEntityType<TileCamoflage>> TILE_CAMOFLAGE = BLOCK_ENTITY_TYPES.register("camoflage", () -> new BlockEntityType<>(TileCamoflage::new, Sets.newHashSet(BlastcraftBlocks.blockCamoflage), null));
