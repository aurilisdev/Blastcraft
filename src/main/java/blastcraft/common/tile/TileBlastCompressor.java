...
public class TileBlastCompressor extends GenericTile implements ITickableSound {
    ...
    public TileBlastCompressor() {
        super(BlastcraftTiles.TILE_BLASTCOMPRESSOR.get());
        ...
        addComponent(new ComponentProcessor(this).canProcess((component, procNumber) -> component.canProcessItem2ItemRecipe(procNumber, BlastcraftRecipies.BLAST_COMPRESSOR_TYPE)).process(ComponentProcessor::processItem2ItemRecipe));
