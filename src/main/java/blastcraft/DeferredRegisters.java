...
public class DeferredRegisters {
	...
	BLOCKS.register("blastproofwallingglass",
		supplier(blockBlastproofWallingGlass = new BlockCustomBrickGlass(50, 12500)));
	BLOCKS.register("rawblastproofwallingglass",
		supplier(blockRawBlastproofWallingGlass = new BlockCustomBrickGlass(2, 50)));
	BLOCKS.register("carbonplatedwallingglass",
		supplier(blockCarbonPlatedWallingGlass = new BlockCustomBrickGlass(85, 18000)));
	...
	ITEMS.register("rawblastproofwalling", supplier(
		new BlockItemDescriptable(blockRawBlastproofWalling, new Item.Properties().group(References.CORETAB))));
	ITEMS.register("carbonplatedwalling", supplier(
		new BlockItemDescriptable(blockCarbonPlatedWalling, new Item.Properties().group(References.CORETAB))));
	ITEMS.register("hardenedbricks", supplier(
		new BlockItemDescriptable(blockHardenedBricks, new Item.Properties().group(References.CORETAB))));
	ITEMS.register("blastproofwallingglass", supplier(new BlockItemDescriptable(blockBlastproofWallingGlass,
		new Item.Properties().group(References.CORETAB))));
	ITEMS.register("rawblastproofwallingglass", supplier(new BlockItemDescriptable(blockRawBlastproofWallingGlass,
		new Item.Properties().group(References.CORETAB))));
	ITEMS.register("carbonplatedwallingglass", supplier(new BlockItemDescriptable(blockCarbonPlatedWallingGlass,
		new Item.Properties().group(References.CORETAB))));
	...
	MachineRecipes.registerRecipe(TILE_BLASTCOMPRESSOR.get(),
		new O2OProcessingRecipe(blockRawBlastproofWalling, blockBlastproofWalling));
    }
