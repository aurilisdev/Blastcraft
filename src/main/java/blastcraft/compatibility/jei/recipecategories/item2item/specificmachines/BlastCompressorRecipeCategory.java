...
public class BlastCompressorRecipeCategory extends Item2ItemRecipeCategory<BlastCompressorRecipe> {
	...
	public static final RecipeType<BlastCompressorRecipe> RECIPE_TYPE = RecipeType.create(Blastcraft.ID, BlastCompressorRecipe.RECIPE_GROUP, BlastCompressorRecipe.class);
