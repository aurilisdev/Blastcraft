package blastcraft.compatability.jei.recipecategories.item2item.specificmachines;
...
public class BlastCompressorRecipeCategory extends Item2ItemRecipeCategory {
